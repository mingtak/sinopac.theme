...
#
#  $ bin/test -s sinopac.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sinopac.theme.testing.SINOPAC_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sinopac/theme/tests/robot/test_example.robot
#
